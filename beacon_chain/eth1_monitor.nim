...
proc init*(T: type Eth1Monitor,
           ...
           web3Url: string,
           depositContractAddress: Eth1Address,
           initialDepositContractSnapshot: DepositContractSnapshot,
           eth1Network: Option[Eth1Network]): Future[Result[T, string]] {.async.} =

  var web3Url = web3Url
  fixupWeb3Urls web3Url

  putInitialDepositContractSnapshot(db, initialDepositContractSnapshot)
